...
COMFYUI_IMAGE_TIMEOUT_MS=1800000
COMFYUI_VIDEO_TIMEOUT_MS=7200000
COMFYUI_RESTART_ON_TIMEOUT=true
COMFYUI_RESTART_TIMEOUT_MS=120000
```
...
| `COMFYUI_IMAGE_TIMEOUT_MS` | `1800000` | ComfyUI image task timeout |
| `COMFYUI_VIDEO_TIMEOUT_MS` | `7200000` | ComfyUI video task timeout |
| `COMFYUI_RESTART_ON_TIMEOUT` | `true` | Restart local ComfyUI when a ComfyUI task times out |
| `COMFYUI_RESTART_TIMEOUT_MS` | `120000` | Wait time for ComfyUI to become healthy after restart |
